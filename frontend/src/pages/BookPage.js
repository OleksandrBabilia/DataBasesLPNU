...
const BookList = () => {
    ...
    const filteredBooks = books.filter((book) => {
        ...
        const matchesSearch = searchQuery ? (
            ...
            authors[book.author[0]].toLowerCase().includes(searchQuery.toLowerCase()) ||
            book.isbn.includes(searchQuery) ||
            publishers[book.publisher].toLowerCase().includes(searchQuery.toLowerCase())
        ) : true;
                ...
                <div className="col-md-8">
                    ...
                    <div className="d-flex justify-content-center mt-4">
                        {paginationRange().map((page, index) => (
                            page === '...' ? (
                                <button key={index} className="btn btn-secondary disabled">...</button>
                            ) : (
                                <button
                                    key={index}
